...
const Features = () => {
  ...
  const genreColors = {
    Fiction: 'blue',
    NonFiction: 'green',
    ScienceFiction: 'purple',
  };

  return (
    <main className="bg-[#F3F4F6]">
      <div className="max-w-6xl mx-auto p-8 md:p-2">
        <h1 className="mb-4 text-xl text-center font-extrabold leading-none tracking-tight text-gray-700 md:text-2xl lg:text-4xl dark:text-white">
